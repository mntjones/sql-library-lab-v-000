...
def select_series_title_with_most_human_characters
  "SELECT series.title, characters.species FROM series INNER JOIN characters ON series.author_id = characters.author_id HAVING characters.species = 'human' ORDER BY COUNT(series.title) DESC LIMIT 1;"
