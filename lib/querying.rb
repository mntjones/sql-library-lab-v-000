...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM series INNER JOIN characters HAVING COUNT(characters.species = 'human') GROUP BY characters.series_id ORDER BY COUNT(characters.species = 'human') DESC LIMIT 1;"
