...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT(character_books.book_id) FROM characters INNER JOIN character_books ON character_id GROUP BY character_book.character_id ORDER BY COUNT(character_books.book_id);"
