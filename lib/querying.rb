...
def select_series_title_with_most_human_characters
  "SELECT series.title, COUNT(characters.species = 'human') FROM series INNER JOIN characters GROUP BY characters.series_id HAVING COUNT(characters.species = 'human') ORDER BY COUNT(characters.species = 'human') DESC LIMIT 1;"
